...
def print_menu():
    ...
    print("  [1] Primary Database OOM & Failover (P0)")
    print("  [2] Cache Stampede & Gateway Timeouts")
    print("  [3] Third-Party Payment Gateway Outage")
    print("  [4] Bad CI/CD Deployment (CrashLoopBackOff)")
    print("  [5] DNS/Network Partition")
    print("  [0] Just Background Noise (No Incidents)")
    print("  [q] Quit")
    print("\n" + "-"*60)
